...
class TroubleshootingEntry(models.Model):
    ...
    estimated_time = models.PositiveIntegerField(null=True, blank=True, help_text="Estimated time to resolve in minutes")
    ...
    # Metadata
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='authored_entries')
    priority = models.CharField(max_length=10, choices=PRIORITY_CHOICES, default='MEDIUM')
    status = models.CharField(max_length=15, choices=STATUS_CHOICES, default='PUBLISHED')
    
    # Verification System
    is_verified = models.BooleanField(default=False)
    verified_by = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, related_name='verified_entries')
...
class EntryRevision(models.Model):
    ...
    entry = models.ForeignKey(TroubleshootingEntry, on_delete=models.CASCADE, related_name='revisions')
...
class Attachment(models.Model):
    ...
    troubleshooting_entry = models.ForeignKey(TroubleshootingEntry, on_delete=models.CASCADE, related_name='attachments')
    file = models.FileField(upload_to='troubleshooting_attachments/%Y/%m/')
...
class Vote(models.Model):
    ...
    troubleshooting_entry = models.ForeignKey(TroubleshootingEntry, on_delete=models.CASCADE, related_name='votes')
...
class Comment(models.Model):
    troubleshooting_entry = models.ForeignKey(TroubleshootingEntry, on_delete=models.CASCADE, related_name='comments')
    parent = models.ForeignKey('self', null=True, blank=True, on_delete=models.CASCADE, related_name='replies')
    author = models.ForeignKey(User, on_delete=models.CASCADE)
    content = models.TextField()
    is_solution = models.BooleanField(default=False)  # Mark if this comment provides an alternative solution
